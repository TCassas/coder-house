const dataMock = [
    ...
    {
        name: "Vinland Saga",
        img: "/imgs/vinland-saga-cover.jpeg",
    ...
    },    
    {
        ...
        audience: "+16",
        genres: ["love", "psychological"],
        id: 6
    },    
    {
        name: "I Am a Hero",
        img: "/imgs/i-am-a-hero-cover.jpg",
    ...
    {
        name: "Chainsaw Man",
        img: "/imgs/chainsaw-man-cover.png",
...
const getProductByGenre = (genreSearch) => {
    return new Promise((resolve, reject) => {
        setTimeout(() => {
            resolve(dataMock.filter(item => item.genres.includes(genreSearch.toLowerCase())))
        },2000)
    })
}
